...
app.use(express.static(PUBLIC_DIR, {
  setHeaders: (res, filePath) => {
    ...
    res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline'; img-src 'self' data: https:;");
  }
}));
...
import { debugFleetBreakdownHandler } from './routes/debug-fleet-breakdown.js';
app.post('/api/debug/fleet-breakdown', debugFleetBreakdownHandler);
