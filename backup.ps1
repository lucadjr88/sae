...
$Tag = "backup_v$Date"
Write-Host "Creazione tag: $Tag" -ForegroundColor Magenta
...
Write-Host "Tag creato: $Tag" -ForegroundColor Magenta
Write-Host ""
...
Write-Host ""
Write-Host "Lista tag backup:" -ForegroundColor Yellow  
