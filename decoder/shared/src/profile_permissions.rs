// Modulo condiviso: ProfilePermissions
...
impl ProfilePermissions {
    // ...eventuali metodi condivisi...
    /// Construct ProfilePermissions from a little-endian byte array
    pub fn from_le_bytes(bytes: [u8; 8]) -> Self {
        Self::from_bits_truncate(u64::from_le_bytes(bytes))
    }
}
