// @ts-nocheck
// Type imports for fleet data structures
/// <reference path="../types/globals.d.ts" />
import { FeesByFleet, FleetFeeData, OperationStats } from '@types/operation-list.js';
import { CraftingDetail } from '../types/details.js';
