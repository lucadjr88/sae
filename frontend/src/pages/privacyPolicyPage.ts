...
function renderPrivacyPolicyPage(): void {
  ...
  contentContainer.innerHTML = `
    <div class="content">
      ...
      <p>While we do not collect traditional personal information (like your name or email), the following data is processed:</p>
      ...
      <p>Local Caching: Your Wallet Public Key and On-chain Transaction data may be temporarily stored in your browser's cache or local storage.</p>
      ...
      <p>The app interacts with blockchain nodes and public APIs to retrieve on-chain data. These services may see your public wallet address as part of the request, but they do not receive any other personal information from us.</p>

      <h2>5. Security</h2>
      <p>Please remember that blockchain transactions are public by nature. We do not have access to your private keys and will never ask for them.</p>
