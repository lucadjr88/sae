...
export function normalizeOpName(opName: string): string {
    ...
    if (lower.includes('fleetstatehandler_mining') || lower.includes('startminingasteroid')) return 'Mining';
    if (lower.includes('fleetstatehandler_subwarp') || lower.includes('startsubwarp')) return 'Subwarp';
