...
export async function getWalletTxsHandler(req, res) {
    // Funzione di double-check: dopo la prima fetch, rifà getSignaturesForAddress e controlla la presenza delle tx in cache
    async function doubleCheckWallet(wallet, cutoffH, profileId) {
    ...
    try {
        ...
        try {
            await (await import("../../utils/rpc/rpc-pool-manager.js")).RpcPoolManager.ensurePool(profileId, false);
        }
        catch (e) {
